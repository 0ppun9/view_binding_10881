...
object TaskList {
    val tasklist = listOf<Task>(
        ...
        Task("Chapter 2", "Nguli genshin impact ", "Mencari Primo buat Gatcha mama Yaemiko tercinta / Keqing Wangi"),
        Task("Chapter 3", "Ngopi", "Habis capek Nguli, kan enak ngopi ya kan"),
        Task("Chapter 4", "Dimana mama Ei?", "Buat aduk Mekanik showcase ayaka pyro"),
